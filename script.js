      ...
      if (cont < 20) {
        ...
        if (!condicion) {
          ...
          document.getElementById(
            "showBreed"
          ).innerText = `¡Has encontrado un ${raza}!`;
          frecuencias[cont - 1] = 1;
          cont++;
        } else {
        ...
        fetch("https://api.thecatapi.com/v1/images/search")
          ...
          .then(() => {
            ...
            document.getElementById(`c${cont}`).src = foto;
            document.getElementById("showBreed").innerText =
              "¡Ups! se ha colado un gato";
            document.getElementById("titulo").innerText = "Gatos";
            document.getElementById("favIcon").href =
              "http://4.bp.blogspot.com/-g3tGAC5psHg/UPHMfH-wMQI/AAAAAAAAAY4/VmD17lwrIww/s1600/BCPicon123.jpg";
          });
      }
